...
g=9.8; /* Preset acceleration of gravity (m/s2) value / h=10.0; / Preset height (m) value */
...
u=v; /* Set the initial velocity for the next increment of the loop to the current velocity */
